...
const Social=()=>{
    const socialIcons=socialLinks.map((socialLink, index)=>{
       ...
       <div data-aos="fade-up-left" data-aos-duration="800" > <socialLink.icon stroke={1.5} className="-rotate-90" size={35} /></div>
    </a>
    })

    return <div  className="flex md-mx:hidden text-textColor items-center gap-8 fixed bottom-32 -left-48 rotate-90 " >
        {socialIcons}
        <hr className="border w-60 rounded-full  bg-textColor border-textColor"/>
    </div>
}
